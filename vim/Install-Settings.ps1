...
# Install bundles
git clone https://github.com/neoclide/coc.nvim.git $vimDir/pack/coc/plugins/start/coc
git clone https://github.com/prettier/vim-prettier $vimDir/pack/vim-prettier/plugins/start/vim-prettier
